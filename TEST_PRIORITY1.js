...
console.log(
  "✅ Footer shows year:",
  copyYearSpan?.textContent || "NOT UPDATED YET"
);
...
console.log(
  "✅ includeHTML function available:",
  typeof window.__kp?.includeHTML === "function"
);
console.log(
  "✅ initHeaderMenu function available:",
  typeof window.__kp?.initHeaderMenu === "function"
);
